...
setvar soundcloud		0.1+13.10.20130723	0ubuntu2 + "unity-lenses/unity-lens-meta[music]"						## works
...
setvar virtualbox		0.1+13.10.20130723	0ubuntu2 + ""											## works
#setvar yahoostock		0.1+13.10.20130723	0ubuntu1 - ""											## doesn't work
setvar yelp			0.1+13.10.20130723	0ubuntu1 + ""											## works
setvar zotero			0.1+13.10.20130723	0ubuntu2 - ""											## not tested (Zotero 4.0 for Firefox is being replaced by a Zotero Connector for Firefox)
