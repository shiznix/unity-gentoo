...
inherit autotools bash-completion-r1 epunt-cxx gnome2 libtool eutils multilib pax-utils python-r1 toolchain-funcs versionator virtualx linux-info multilib-minimal ubuntu-versionator
